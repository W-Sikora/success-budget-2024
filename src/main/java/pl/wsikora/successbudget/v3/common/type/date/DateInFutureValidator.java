...
public class DateInFutureValidator implements ValidatorErrorCode {

	private DateInFutureValidator() {}
	...
	public static void validate(String fieldName, @Nullable String date, Errors errors) {
		...
		else if (!Date.isInFuture(date)) {

			errors.rejectValue(fieldName, E_DATE_MUST_BE_IN_FUTURE);
		}
	}
}
