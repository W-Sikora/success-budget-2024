...
public class AmountGreaterThanOrEqualToZeroValidator implements ValidatorErrorCode {

	private AmountGreaterThanOrEqualToZeroValidator() {}
	...
	public static void validate(String fieldName, @Nullable BigDecimal amount, Errors errors) {
		...
		else if (!Money.hasValidValue(amount)) {
